...
if [[ -z $HADOOP_HOME ]] ; then
   test -z "$HADOOP_PREFIX"      && export HADOOP_PREFIX=/home/pi/Share/dp/hadoop
else
...
test -z "$JAVA_HOME"             && export JAVA_HOME=/usr/lib/jvm/java-8-openjdk-armhf/
test -z "$ZOOKEEPER_HOME"        && export ZOOKEEPER_HOME=/home/pi/Share/dp/zookeeper
